...
<div class="relative max-w-5xl mx-auto mt-2">
    ...
    <div class="bg-white/70 backdrop-blur-2xl p-2 rounded-3xl shadow-xl border border-white relative z-10 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-gray-900 to-gray-800 p-3 rounded-xl text-white relative overflow-hidden">
            <div class="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-10"></div>
            
            <div class="relative z-10 flex items-center justify-between">
                <div>
                    <h2 class="text-sm font-black tracking-tight leading-none">Ajustes del Entorno</h2>
                    <p class="text-gray-400 font-bold text-[8px] uppercase tracking-widest opacity-60 mt-0.5">Módulo, notificaciones y perfil</p>
                </div>
                <div class="w-7 h-7 bg-white/5 backdrop-blur-md rounded-lg flex items-center justify-center border border-white/10 text-[10px] shadow-inner">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 p-4 sm:p-6">
            ...
            <div class="lg:col-span-4 space-y-4">
                <div class="bg-white rounded-[1.5rem] p-5 shadow-sm border border-gray-100 text-center hover:shadow-xl transition-all duration-300 relative group overflow-hidden">
                    <div class="absolute inset-x-0 top-0 h-20 bg-gray-50 group-hover:bg-sena-50 transition-colors duration-500"></div>
                    <div class="relative z-10 pt-2">
                        <div class="relative inline-block">
                            <img src="https://ui-avatars.com/api/?name={{ urlencode($asesor->persona->pers_nombres ?? 'Carlos Ruiz') }}&background=39A900&color=fff&size=128&bold=true" class="w-20 h-20 rounded-2xl border-4 border-white mx-auto shadow-md transform group-hover:scale-105 transition-transform duration-300" alt="Profile">
                            <span class="absolute bottom-1 -right-1 w-3.5 h-3.5 bg-emerald-500 border-2 border-white rounded-full shadow-sm"></span>
                        </div>
                        <h3 class="text-base font-black text-gray-900 leading-tight mt-3 mb-1">{{ $asesor->persona->pers_nombres ?? 'Carlos Ruiz' }}</h3>
                        <p class="text-[9px] font-black text-sena-500 uppercase tracking-widest bg-sena-50 px-2 py-0.5 rounded-lg inline-block">Asesor Módulo {{ $asesor->modulo ?? '04' }}</p>
                        
                        <div class="mt-4 pt-4 border-t border-gray-50">
                            <button class="w-full bg-gray-900 text-white font-black py-2.5 rounded-xl text-[9px] uppercase tracking-widest hover:bg-black transition-colors flex items-center justify-center space-x-2 shadow-lg">
            ...
            <div class="lg:col-span-8">
                <div class="bg-white rounded-[1.5rem] p-5 shadow-sm border border-gray-100 h-full flex flex-col justify-between">
                    ...
                    <div class="space-y-8">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                <div class="group">
                                    <label class="block text-[8px] font-black text-gray-400 uppercase tracking-widest mb-1.5 pl-1 group-hover:text-sena-500 transition-colors">Número de Módulo</label>
                                    <div class="relative">
                                        <div class="absolute left-2.5 top-1/2 -translate-y-1/2 w-6 h-6 bg-gray-100 rounded-lg flex items-center justify-center text-gray-400">
                                            <i class="fa-solid fa-hashtag text-[8px]"></i>
                                        </div>
                                        <input type="text" value="{{ $asesor->modulo ?? '04' }}" class="w-full bg-gray-50 border border-gray-100 rounded-xl pl-10 pr-3 py-2.5 text-xs font-black text-gray-700 outline-none focus:ring-2 focus:ring-sena-500 transition-all shadow-inner" readonly>
                                    </div>
                                </div>
                                <div class="group">
                                    <label class="block text-[8px] font-black text-gray-400 uppercase tracking-widest mb-1.5 pl-1 group-hover:text-sena-500 transition-colors">Sede Asignada</label>
                                    <div class="relative">
                                        <div class="absolute left-2.5 top-1/2 -translate-y-1/2 w-6 h-6 bg-gray-100 rounded-lg flex items-center justify-center text-gray-400">
                                            <i class="fa-solid fa-building text-[8px]"></i>
                                        </div>
                                        <input type="text" value="Sede Central Antioquia" class="w-full bg-gray-50 border border-gray-100 rounded-xl pl-10 pr-3 py-2.5 text-xs font-black text-gray-700 outline-none transition-all shadow-inner truncate" readonly title="Sede Central Antioquia">
                                    </div>
                                </div>
                            </div>
                        </div>
